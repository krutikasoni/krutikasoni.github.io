...
const greeting = {
  ...
  resumeLink:
    "https://drive.google.com/file/d/1yvoOgK-Pz0k7ZzHcP9L5eFyFJQ8HBPjA/view?usp=sharinghttps://drive.google.com/file/d/1vZBLtbOmOMa3SVTZ5spa9LJCOjMLfPO8/view?usp=sharing",
...
const skillsSection = {
  ...
  skills: [
    emoji("⚒️  Marketing & AdTech Tools: GA4, Adobe Analytics, HubSpot, SEMrush, GTM, Salesforce, Marketing Mix Models"),
    emoji("📊  Business & Data Analytics Tools: PowerBI, Tableau, Excel, Looker Studio, SQL, Python, R"),
    emoji("🧠  Statistical & Modeling Techniques: Forecasting, Regression, A/B Testing, Multivariate Testing, NLP, Clustering"),
    emoji("☁️  Cloud & Data Engineering Tools: AWS (EC2, S3, SageMaker), Google Apps Script, SAP"),
  ],
  softwareSkills: [
    ...
    professional: [
      {
        ...
        desc:
          "Led marketing analytics, campaign optimization, and go-to-market research for ad-tech products with $1.4M+/month in ad spend.",
      },
      {
        ...
        desc:
          "Built and scaled cross-channel campaigns, automated Power BI & Looker Studio dashboards for real-time performance tracking.",
      },
      {
        ...
        desc:
          "Driving LinkedIn marketing strategy, engagement tracking, and GA4 dashboards for an XAI startup.",
      },
    ],
    internships: [
      {
        ...
        desc:
          "Predicted a 20% increase in client acquisition by analyzing customer data and providing actionable insights.",
      },
      {
        role: "HR Intern",
        ...
        desc:
          "Conducted client interaction and feedback analysis, improving onboarding processes.",
      },
    ],
    volunteering: [
      {
        ...
        desc:
          "Organized marketing analytics-focused workshops, marketing sessions, and networking events.",
      },
      {
        ...
        date: "2021 – 2024",
        desc:
          "Coordinated donation drives, managed volunteer groups, and led logistical operations across zones.",
      },
      {
        ...
        date: "2020 – 2022",
        desc:
          "Handled rescues and ran content campaigns for community awareness and pet adoptions.",
      },
    ],
  },
};
